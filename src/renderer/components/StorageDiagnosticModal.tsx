...
import { Modal, Descriptions, Tag, Alert, Button, Collapse, Space, Typography, Card, Statistic, Row, Col, Spin } from 'antd';
      ...
      if (diagnosticResult.success) {
        ...
        if (!diagnosticResult.checks) {
          ...
          if (!diagnosticResult.healthy) {
            ...
            antdMessage.warning(`发现 ${recommendationCount} 个问题，建议查看详情`);
          } else {
            antdMessage.success('存储系统健康');
          }
        }
      } else {
