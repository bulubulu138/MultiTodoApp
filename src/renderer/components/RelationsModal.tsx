                    ...
                    >
                      <Space direction="vertical" style={{ width: '100%' }} size="small">
                        ...
                        <Text type="secondary" style={{ fontSize: '12px' }}>
                          {new Date(item.todo.createdAt).toLocaleString()} · {item.todo.status === 'completed' ? '✅已完成' : item.todo.status === 'in_progress' ? '⏳今日事' : '📋待办'}
                        </Text>
                        {item.todo.content && (
                          <Text 
                            type="secondary" 
                ...
                children: (
                  ...
                  >
                    <Space direction="vertical" style={{ width: '100%' }} size="small">
                      ...
                      <Text type="secondary" style={{ fontSize: '12px' }}>
                        {new Date(todo.createdAt).toLocaleString()} · {todo.status === 'completed' ? '✅已完成' : todo.status === 'in_progress' ? '⏳今日事' : '📋待办'}
                      </Text>
                    </Space>
                  </Card>
                )
