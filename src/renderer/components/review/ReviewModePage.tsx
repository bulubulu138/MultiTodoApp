...
const ReviewModePage: React.FC<ReviewModePageProps> = ({
  onClose,
  todos,
  onDeleteTodo,
}) => {
    ...
    <div className="review-mode-page">
      ...
      <div className="review-mode-header">
        <Space>
          ...
          <span className="review-mode-title">复盘模式</span>
        </Space>
      </div>
